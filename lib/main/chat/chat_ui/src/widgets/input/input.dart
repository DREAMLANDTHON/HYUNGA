...
class _InputState extends State<Input> {
  ...
  void _handleSendPressed() async {
    ...
    if (trimmedText != '') {
      ...
      try {
        String translatedText = await Papago.translateText('en', trimmedText);

        String processedText = trimmedText + "\n-\n" + translatedText;

        final partialText = types.PartialText(text: processedText);
